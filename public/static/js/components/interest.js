...
export const INTERESTS = {
  development: {
    name: "My Development Journey",
    data: "I started out as a quality engineer, finding problems and solving them within a medical device production facility. What I soon learned is that the activities I enjoyed the most involved getting behind the scenes of MicroSoft Excel, tinkering with VBA to make our data collection and analysis better. After a while, I decided that this small part of my job should just be my job. <br><br>So during COVID times I dedicated myself full-time to learning everything I could about coding, focusing on TypeScript and Angular. To round things off, I joined the Coding Temple code camp to pick up some Python & React skills. This led to a job at Beckman Coulter Life Sciences where I found myself developing user portals for scientific instruments, primarily using React.<br><br> What I know today is that I love this job. I can literally do this all day and happily come back for more the next. It gives me the opportunity to strive for my goal of becoming a master craftsman in a creative pursuit and I'm filled with joy thinking of how my efforts may be multiplied a thousand times over as people benefit from the carefully crafted features I've put together.<br><br>I have a lot to learn still, but most importantly, I'm getting comfortable approaching new syntaxes and concepts with ease. I can read an unfamiliar codebase and decide what needs to happen to affect change. I can make things happen. That feels great and I'm going to continue to make things happen.",
    imgUrl:
